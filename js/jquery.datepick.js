...
function Datepicker() {
	this._defaults = {
		...
		//yearRange: 'c-30:c-0', // Range of years to show in drop-down: 'any' for direct text entry
	...
	this.regional = {
		'': { // US/English
			...
			prevText: '&lt;Sig', // Text for the previous month command
			...
			todayStatus: 'Mostrar el mes de éste día', // Status text for the today's month command
			clearText: 'Limpiar', // Text for the clear command
			clearStatus: 'Eliminar todas las fechas', // Status text for the clear command
			...
			dayStatus: 'Selecciona DD, M d, yyyy', // Status text for selectable days
