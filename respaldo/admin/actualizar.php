...
include("forma.php");
if($cual == "categoria"){
	mysql_query("UPDATE zarkin_categoria SET nombre='$nombre' WHERE id = '$idm'");
	$_SESSION['error']=$tituloForma.' Modificad@ Exitosamente.';
}
if($cual=="coleccion"){
	
	mysql_query("UPDATE zarkin_coleccion SET titulo='$titulo',descripcion='$descripcion',idCategoria='$idCategoria' WHERE id='$idm'");
	$idColeccion=$idm;
	...
	$_SESSION['error']=$tituloForma.' Modificada@ Exitosamente.';
