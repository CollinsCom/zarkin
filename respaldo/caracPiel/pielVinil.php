			...
			<tr>
			  <td style="height: 300px;">
			  	<table width="780" height="0%" border="0" cellpadding="0" cellspacing="0">
					...
					<td width="550" background="../images/interface/bgF_07.jpg"><img src="../images/caracPiel/imgPortCaracPiel.jpg" width="550" height="300"></td>
					</tr>
				</table>
			  </td>
			</tr>
						...
						<table width="550" border="0" cellpadding="0" cellspacing="0">
							...
							<td>
								<table width="550" border="0" cellpadding="0" cellspacing="0">
									...
									<div class="txtTitulos2" style="background-color:#aaaaaa">&nbsp;</div>
									<div class="qlinks"><a href="marcas.php" target="_self" class="qlinks">&bull; Marcas Naturales de la Piel</a><br><br>
														<a href="pigmentada.php" target="_self" class="qlinks">&bull; Pieles Pigmentadas</a><br><br>
													    <a href="semianilina.php" target="_self" class="qlinks">&bull; Semianilina</a><br><br>
													    <a href="anilina.php" target="_self" class="qlinks">&bull; Anilina</a><br><br>
														<a href="nobuck.php" target="_self" class="qlinks">&bull; Nobuck</a><br><br>
														<a href="pielVinil.php" target="_self" class="qlinks">&bull; Piel vs Piel y Vinil</a><br><br>
														<a href="cuidados.php" target="_self" class="qlinks">&bull; Cuidados y Limpieza</a><br><br>
														<a href="../caracPiel.php" target="_self" class="qlinks">&bull; Cualidades y Ventajas</a><br>
														<br>
									</div>									
									</td>
									<td width="370" valign="top">
										<div class="txtTitulos"><strong>Piel vs Piel y Vinil</strong></div>
										<div class="txtContenido">Es com&uacute;n que el fabricante, para ahorrar dinero, utilice la piel s&oacute;lo en aquellas partes donde nuestro cuerpo entra en contacto, mientras que en el resto (<i>la mayor parte</i>) es <strong>vinil</strong>. Con el tiempo, el vinil y la piel envejecen diferente.<br><br>Tambi&eacute;n puede utilizar una piel de baja calidad, ya que cuesta menos, pero es muy r&iacute;gida y no luce tan natural y suave como la piel de alta calidad que nosotros utilizamos.<br><br><strong>Tutto Pelle</strong> le ofrece muebles acabados en aut&eacute;ntica piel de res, por eso somos <strong>la &uacute;nica cadena especialista en muebles de piel.</strong><br><br><i>Al comprar un mueble de piel, verifique que sea 100% piel genuina.</i></div><hr>
									</td>
									<td width="20">&nbsp;</td>
									</tr>
							  </table>
