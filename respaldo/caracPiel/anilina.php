							...
							<td>
								<table width="550" border="0" cellpadding="0" cellspacing="0">
									...
									<td width="370" valign="top">
										<div class="txtTitulos"><strong>Piel de Anilina</strong></div>
										<div class="txtContenido">Es una de las m&aacute;s finas al tacto, lo cual la hace una de las m&aacute;s delicadas.<br><br>Este acabado se logra cuando el color de anilina penetra por el poro, teniendo como ventaja que no cambia la superficie ni la tapa.<br><br>Las variantes del color son inevitables, ya que cada piel mantiene su estructura particular.<br><br>Pero para satisfacci&oacute;n suya la piel conserva las huellas heredadas por la naturaleza y la vida del animal como: <i>pliegues de ensanche, picaduras de insectos, etc.</i></div><hr>
									</td>
									<td width="20">&nbsp;</td>
									</tr>
							  </table>
